...
func (m *MTProto) SetInputContact(cid int64, phone, firstname, lastname string) TL_inputPhoneContact {
	contact := TL_inputPhoneContact{client_id: cid, phone: phone, first_name: firstname, last_name: lastname}
	return contact
...
func (m *MTProto) GetInputPhoneAttribute(contact *TL_inputPhoneContact, cid int64, phone, firstname, lastname string) {
	*contact = TL_inputPhoneContact{client_id: cid, phone: phone, first_name: firstname, last_name: lastname}

}
func (m *MTProto) GetContactsForImport() []TL {
	resp := make(chan TL, 1)
...
func (m *MTProto) GetContacts() error {
	...
	fmt.Printf(
		"\033[33m\033[1m%10s    %10s    %-10s    %-10s     \033[0m\n",
...
func (m *MTProto) Contacts_ImportContacts(in []TL) TL_contacts_importedContacts {
	...
	m.queueSend <- packetToSend{
		TL_contacts_importContacts{contacts: in, replace: bFalse},
		resp}
